    ...
    if (variant === 'text') {
        return (
            <div className={cn("flex items-center gap-0.5", className)}>
                ...
                <span className="font-light tracking-widest text-stone-amber">Hardscape</span>
            </div>
        );
    }
    ...
    return (
        <div className={cn("flex items-center gap-3 select-none", className)}>
            ...
            <div className={cn("flex items-baseline leading-none",
                ...
                <span className="font-bold tracking-tight text-white">GableX</span>
                <span className="font-light tracking-widest text-stone-amber ml-0.5">Hardscape</span>
            </div>
        </div>
    );
}

...
const NavItem = ({ icon: Icon, label, active, onClick }: NavItemProps) => (
  ...
  >
    ...
    {active && <motion.div layoutId="activeNav" className="ml-auto w-1 h-4 bg-stone-amber rounded-full" />}
  </button>
);
...
export function Phase0Layout() {
  ...
  return (
    <div className="min-h-screen bg-deep-earth text-white font-sans selection:bg-stone-amber/30">
      {/* Top Banner */}
      <div className="h-14 border-b border-white/5 bg-deep-earth/80 backdrop-blur-xl fixed top-0 inset-x-0 z-50 flex items-center justify-between px-6">
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            <span className="font-serif italic text-lg">Dibbits</span>
            <span className="text-zinc-600">×</span>
            <span className="font-bold tracking-tight">GableX<span className="text-stone-amber font-light">Hardscape</span></span>
          </div>
        ...
        <div className="flex items-center gap-4">
          <div className="flex -space-x-2">
            <div className="w-8 h-8 rounded-full border-2 border-deep-earth bg-zinc-800 flex items-center justify-center text-[10px] font-bold">D</div>
            <div className="w-8 h-8 rounded-full border-2 border-deep-earth bg-stone-amber flex items-center justify-center text-[10px] font-bold text-deep-earth">G</div>
          </div>
        ...
        >
          <div className="p-4 space-y-2 w-[260px]">
            <div className="mb-8 px-2">
              <h2 className="text-[10px] uppercase tracking-[0.2em] font-bold text-stone-amber/50 mb-1">Execution Track</h2>
          ...
          <div className="absolute bottom-6 inset-x-0 px-6">
            <div className="p-4 rounded-xl bg-gradient-to-br from-stone-amber/20 to-transparent border border-stone-amber/10">
              <div className="text-[10px] uppercase tracking-wider font-bold text-stone-amber mb-2">Phase 0 Status</div>
              <div className="h-1.5 w-full bg-black/40 rounded-full overflow-hidden">
                <div className="h-full w-1/4 bg-stone-amber rounded-full" />
              </div>
